...
$app->group('/cd', function () {   
    ...
    $this->post('/', function (Request $request, Response $response) {
        ...
        $ArrayDeParametros2 = $request->getParsedBody();
        /*var_dump($ArrayDeParametros2);
        $id = $ArrayDeParametros2['id'];*/ //corregir esto porque asi como esta no funciona
        $archivos['foto']->moveTo($destino.$titulo."_".$id.".".$extension[0]);
